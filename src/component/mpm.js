...
class Mpm extends Component {
  ...
  render() {
    ...
    // let actualReward = this.state.details.totalStaticReward
    //   - this.state.details.staticReward
    //   - this.state.details.collideReward
    //   - this.state.details.dynamicReward;
...
function QuotaWarningImg(props) {
  ...
  if (warn) {
    return (
      <img src={require("../img/warning.png")} style={{ marginLeft: '1rem', width: '2.4rem', height: '1.8rem' }} />
    );
  }
  return (<span></span>);
}
